    ...
    render() {
        return (
            <View style={Styles.container}>
                ...
                <TouchableHighlight  underlayColor='#f2f2f2' style={{backgroundColor:'#d6d6d6'}} onPress={()=>{this.props.navigation.navigate('student') }} >
                ...
                <TouchableHighlight  underlayColor='#f2f2f2' style={{backgroundColor:'#d6d6d6'}} onPress={()=>{this.props.navigation.navigate('applyCoach') }} >
                    <View style={{width:'100%',height:50,flexDirection:'row',alignItems:'center'}}>
                        <Image style={{marginLeft:15,width:22,height:22}} source={require('../../../res/images/iconjiaolian.png')}></Image>
                ...
                <View style={{backgroundColor:'#cdcdcd',height:1,width:'100%'}}></View>
                <TouchableHighlight  underlayColor='#f2f2f2' style={{backgroundColor:'#d6d6d6'}} onPress={()=>{this.props.navigation.navigate('setTimeOrder') }} >
                    <View style={{width:'100%',height:50,flexDirection:'row',alignItems:'center'}}>
                        <Image style={{marginLeft:15,width:22,height:22}} source={require('../../../res/images/iconjiaolian.png')}></Image>
