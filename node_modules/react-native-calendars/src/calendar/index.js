...
class Calendar extends Component {
  ...
  renderDay(day, id) {
    ...
    if (!dateutils.sameMonth(day, this.state.currentMonth) && this.props.hideExtraDays) {
      ...
      let heightt = this.props.markingType === 'interactive' ? 50 : 35;
      dayComp = (
          <View  style={{width:60,alignItems:'center'}}>
            <DayComp
              ...
              {
                state!='disabled'?
                <Switch backgroundActive="#D33A31" height={15} width={30}  onValueChange={(value) => this.setState({trueSwitchIsOn: value})} disabled={false}
